...
This API allows you manage a pool of questions and its associated categories for an aesthetic Trivia game.
...
`curl http://localhost:5000/leaderboard -X POST -H "{Content-Type: 'application/json'}" -d '{ "player": "Pinokio Jay" "score": 4 }'`
